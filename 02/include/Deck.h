...
typedef int (*Deck_lengthOfSlice) (Deck const * deck, int start);
typedef int (*Deck_indexOfHighest) (Deck const * deck, int start);
typedef bool (*Deck_predicate) (Deck const * deck);
